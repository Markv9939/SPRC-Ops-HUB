...
12. **Prepared locally; release pending:** Deploy the compatibility-session cutover guard and privacy-safe readiness audit. The guard returns a legacy browser session to the PIN screen when strict authorization turns on instead of leaving staff on a broken permission-error screen.
