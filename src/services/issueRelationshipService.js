...
export async function keepIssueSeparate({ issueId, reason, actorUser }) {
...
export async function linkIssueAsFollowUp({ childIssueId, parentIssueId, reason, reopenParent = false, actorUser }) {
...
export async function classifyQuickReport({ issueId, trackingId, checklistLabel, categoryLabel, reason, actorUser }) {
...
export async function unlinkIssueRelationship({ issueId, reason, actorUser }) {
  const note = trim(reason)
